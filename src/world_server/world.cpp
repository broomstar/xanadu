...
World::World(bool is_dedicated_server) :
	...
	mysql_session_("MySQL", "user=root;password=xxxx;db=xanadu83;auto-reconnect=true")
{
	instance_ = this;
}
...
{
	// create and prepare the wz_reader reader for usage

	wz_reader_ = new WZMain();
	wz_reader_->initialize();

	// load .wz_reader file data
