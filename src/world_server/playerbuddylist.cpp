...
#include "constants/buddylist_constants.hpp"
#include "world.hpp"
...
void Player::add_buddy(int player_id, std::string name, int channel_id) {
    buddies_[player_id] = std::shared_ptr<Buddy>(
            new Buddy(player_id, channel_id, name));
}
...
void
Player::change_buddy_channel(Player *buddy, int player_id, int channel_id) {
