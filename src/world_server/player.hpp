...
public:
    ...
    void initialize_player_quests(int quest_id, bool isCompleted, int mob_id,
                                  int amount);
    ...
    void movement_handler(short &position_x, short &position_y, short &foothold,
                          signed char &stance);
