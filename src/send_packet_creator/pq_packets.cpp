...
void
PacketCreator::obtain_party_cp(unsigned char team, short cp, short total_cp) {
...
void
PacketCreator::carnival_pq_summon(signed char tab, signed char summon_number,
...
void PacketCreator::leave_carnival_pq(bool player_is_leader, unsigned char team,
                                      std::string player_name) {
