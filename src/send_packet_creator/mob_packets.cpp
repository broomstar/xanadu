...
void
PacketCreator::MoveMob(int mob_object_id, bool use_skill, signed char action,
                       signed char skill_id, signed char skill_level,
                       short option, short start_position_x,
...
void PacketCreator::MoveMobResponse(Mob *mob, short move_id, bool use_skill,
                                    signed char skill_id,
