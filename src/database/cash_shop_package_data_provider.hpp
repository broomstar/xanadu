...
public:
    ...
    // copy constructor
    CashShopPackageDataProvider(
            const CashShopPackageDataProvider &other) = delete;
    ...
    CashShopPackageDataProvider &
    operator=(const CashShopPackageDataProvider &other) = delete;

    // move assignment operator
    CashShopPackageDataProvider &
    operator=(CashShopPackageDataProvider &&other) = delete;
