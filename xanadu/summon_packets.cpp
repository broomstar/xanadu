...
void PacketCreator::DamageSummon(int player_id, int skill_id, int damage,
                                 signed char unk, int mob_id_from) {
...
void PacketCreator::DamageMobSummon(Player *player, int summon_object_id,
