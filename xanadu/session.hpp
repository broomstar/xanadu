...
public:
    ...
    void read_header_handler(const std::error_code &ec,
                             std::size_t bytes_transferred);

    void
    read_body_handler(const std::error_code &ec, std::size_t bytes_transferred);

    void send_handler(const std::error_code &ec, std::size_t bytes_transferred,
