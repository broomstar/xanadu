...
void PacketCreator::ShowSkillEffect(int player_id, int skill_id,
                                    signed char skill_level, signed char flags,
                                    signed char speed) {
...
void
PacketCreator::UpdateSkill(int skill_id, int skill_level, int master_level) {
    write<short>(send_headers::kUPDATE_SKILLS);
    write<signed char>(1);
...
void PacketCreator::SpawnDoor(int object_id, bool town, short position_x,
                              short position_y) {
...
void
PacketCreator::SpawnMist(int object_id, int owner_character_id, int skill_id,
