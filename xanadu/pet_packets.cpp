...
void PacketCreator::ShowPet(int owner_player_id, std::shared_ptr<Item> pet,
                            bool show) {
...
void PacketCreator::MovePet(int owner_player_id, signed char pet_slot,
...
void PacketCreator::ShowPetChat(int owner_player_id, std::shared_ptr<Item> pet,
                                signed char act, const std::string &message) {
...
void
PacketCreator::PetCommandReplay(int owner_player_id, std::shared_ptr<Item> pet,
